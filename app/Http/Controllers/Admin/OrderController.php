...
class OrderController extends Controller
{
    ...
    public function paymentHistory() {
        // Correcting issues in the Skydash Admin Panel Sidebar using Session
        Session::put('page', 'payment-history');
        ...
        return view('admin.orders.payments')->with(compact('orders'));
    }
                ...
                <section>
                    <div class="container">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    <th class="desc">Package Code</th>
                                    <th class="desc">Name of Package</th>
                                    <th class="qty">Pax</th>
                                    <th class="qty">Theme</th>
                                    <th class="qty">Quantity</th>
                                    <th class="total">Event Date</th>
                            ...
                            foreach ($orderDetails['orders_products'] as $product) {
                                ...
                                $invoiceHTML .= '
                                    <tr>
                                        ...
                                        <td class="desc">' . $product['event_date'] . '</td>
