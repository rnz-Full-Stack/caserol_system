...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $mostOrderedProducts = \App\Models\OrdersProduct::selectRaw('DATE_FORMAT(orders_products.created_at, "%b") as month, product_id, COUNT(*) as order_count, product_name')
            ...
            ->whereYear('orders_products.created_at', date('Y'))
       ...
       // return $barData;
        ...
        foreach ($productsData as $item) {
            $barchart_labels[] = $item->product_name;
            $barchart_values[] = $item->order_count;
        }
        ...
        return view('admin/dashboard')
            ->with(compact(
                ...
                'barchart_labels',
                'barchart_values'
            )); // is the same as:    return view('admin.dashboard');
    }
