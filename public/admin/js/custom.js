...
$(document).ready(function() {
    ...
    $('input[name="price_per_pax"]').on('keyup', function() {
        let pax = $('input[name="pax"]').val();
        let product_price = $(this).val() * pax;
        $('#product_price').text(product_price.toFixed(2))
    });

    $('input[name="pax"]').on('keyup', function() {
        let pax = $(this).val();
        let product_price = $('input[name="price_per_pax"]').val() * pax;
        $('#product_price').text(product_price.toFixed(2))
    });
