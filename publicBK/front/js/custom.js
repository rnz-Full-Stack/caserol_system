...
$(document).ready(function() {
    ...
    // Edit Venue Addresses via AJAX (Page refresh and fill in the <input> fields with the authenticated/logged in user Venue Addresses details from the `delivery_addresses` database table when clicking on the Edit button) in front/products/delivery_addresses.blade.php (which is 'include'-ed in front/products/checkout.blade.php) via AJAX, check front/js/custom.js
    $(document).on('click', '.editAddress', function() {
        ...
        $.ajax({
            ...
            success: function(resp) { // if the AJAX request / AJAX call is successful
                ...
                $('.newAddress').hide();
                $('.deliveryText').text('Edit Venue Address');
    ...
    // Calculate the Grand Total, Shipping Charges and Coupon Amount and displaying them depending on the chosen Venue Address in front/products/checkout.blade.php
    ...
    // PIN code Availability Check: check if the PIN code of the user's Venue Address exists in our database (in both `cod_pincodes` and `prepaid_pincodes`) or not in front/products/detail.blade.php via AJAX
