                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}" method="post" enctype="multipart/form-data"> @csrf <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" value="Philippines" name="shop_country"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="shop_mobile" placeholder="Enter 11 Digit Shop Mobile Number" name="shop_mobile"  @if (isset($vendorDetails['shop_mobile'])) value="{{ $vendorDetails['shop_mobile'] }}" @endif maxlength="11" minlength="11">
                                    </div>
                                    <div class="form-group">
