                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/update-admin-details') }}" method="post" enctype="multipart/form-data"> @csrf <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="admin_mobile" placeholder="Enter 11 Digit Mobile Number" name="admin_mobile" value="{{ Auth::guard('admin')->user()->mobile }}" maxlength="11" minlength="11"> {{-- Accessing Specific Guard Instances: https://laravel.com/docs/9.x/authentication#accessing-specific-guard-instances --}}
                                </div>
                                <div class="form-group">
