    					...
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							...
        							<td class="text-center"><strong>Name of Package</strong></td>
        							<td class="text-center"><strong>Pax</strong></td>
        							<td class="text-center"><strong>Theme</strong></td>
        							<td class="text-center"><strong>Price</strong></td>
        							<td class="text-center"><strong>Quantity</strong></td>
        							<td class="text-right"><strong>Totals</strong></td>
        							<td class="text-right"><strong>Event Date</strong></td>
                                </tr>
    						</thead>
    						<tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $product['event_date'] }}</td>
                                    </tr>
