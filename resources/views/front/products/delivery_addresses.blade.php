{{-- This page is 'include'-ed in front/products/checkout.blade.php, and will be used by jQuery AJAX to reload it, check front/js/custom.js --}}
    ...
    <div class="u-s-m-b-24">
        ...
        @else {{-- if there're no already existing Venue Addresses --}}
    ...
    <div class="collapse" id="showdifferent">
        ...
        <form id="addressAddEditForm" action="javascript:;" method="post">
            ...
            <input type="hidden" name="delivery_id"> {{-- We created this hidden <input> field to submit the Venue Address id when this HTML Form is submitted via AJAX to save the Venue Address in the `delivery_addresses` database table. Check the Save Venue Addresses via AJAX function in front/js/custom.js file --}}
