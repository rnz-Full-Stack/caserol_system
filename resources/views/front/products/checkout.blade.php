                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                {{-- The complete HTML Form of the user submitting their Venue Address and Payment Method --}}
                                <form name="checkoutForm" id="checkoutForm" action="{{ url('/checkout') }}" method="post">
                                    ...
                                    @if (count($deliveryAddresses) > 0) {{-- Checking if there are any $deliveryAddreses for the currently authenticated/logged-in user --}} {{-- $deliveryAddresses variable is passed in from checkout() method in Front/ProductsController.php --}}
                                        ...
                                        <h4 class="section-h4">Venue Addresses</h4>
                                    ...
                                    <div class="order-table">
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach ($item['addons'] as $addon)
                                                            ...
                                                            <div>
                                                                <small>
                                                                    {{ $addon_info->addon_name }} P{{ $addon['amount'] }} ({{ $addon_info->addon_detail }})
                                                                </small>
                                                            </div>
                                                            <div><small>Qty: {{ $addon['qty'] }}</small></div>
                                                            <div><small>Subtotal: {{ $addon_total }}</small></div>
                                                            <hr>
                                                        @endforeach
                                                        </td>
                                                        <td>
                                                            <h6 class="order-h6">P{{ $subtotal }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                        ...
                                        <div> {{-- We added the codMethod CSS class to disable that payment method (check front/js/custom.js) if the PIN code of that user's Venue Address doesn't exist in our `cod_pincodes` database table --}}
                                        ...
                                        <div class="u-s-m-b-13">
                                            ...
                                            <label class="label-text no-color" for="accept">I’ve read and accept the
                                                <a href="{{ asset('terms-and-conditions.html') }}" class="u-c-brand">terms & conditions</a>
                                            </label>
                                        </div>
