    ...
    <section class="section-maker">
        <div class="container">
            <div class="sec-maker-header text-center">
                <h3 class="sec-maker-h3">TOP SERVICES</h3>
                <ul class="nav tab-nav-style-1-a justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#men-latest-products">New Catering Setup</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#men-best-selling-products">Best Setups</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="tab-pane active show fade" id="men-latest-products">
                            <div class="slider-fouc">
                                <div class="products-slider owl-carousel" data-item="4">
                                    ...
                                    {{-- Show 'New Catering Setup'. Show the LATEST 8 products ONLY. Check the index() method in IndexController.php --}}
                        ...
                        <div class="tab-pane show fade" id="men-best-selling-products">
                            <div class="slider-fouc">
                                <div class="products-slider owl-carousel" data-item="4">
                                    ...
                                    {{-- Show the 'Best Setup' products. Check the index() method in IndexController.php --}}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="single-item-wrapper">
                            ...
                            <p>Our Protection covers your purchase from click to services</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="single-item-wrapper">
                            ...
                            <p>Pay with secure payment method</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="single-item-wrapper">
                            ...
                            <p>Round-the-clock assistance for a smooth experience</p>
                        </div>
                    </div>
                </div>
            </div>
