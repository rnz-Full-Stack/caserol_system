...
<footer class="footer">
    <div class="container">
        ...
        <div class="outer-footer-wrapper u-s-p-y-80">
            ...
            <p>
                Subscribe to the mailing list to receive updates on promotions, new offer, discount and coupons.
            </p>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="footer-list">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#">Social Event Catering</a>
                            </li>
                            <li>
                                <a href="#">Concession Catering</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="footer-list">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="tel:09101234567">
                                <i class="fas fa-phone u-s-m-r-9"></i>
                                <span>09101234567</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:case.role.01@gmail.com">
                                <i class="fas fa-envelope u-s-m-r-9"></i>
                                <span>
                                case.role.01@gmail.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="bottom-footer-wrapper">
            ...
            <p class="copyright-text">Copyright &copy; 2023
                <a target="_blank" rel="nofollow" href="#">CASEROLE</a> | All Right Reserved
            </p>
        </div>
    </div>
    <!-- Bottom-Footer /- -->
